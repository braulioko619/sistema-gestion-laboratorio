...
router.use('/checklist-template', require('./checklisttemplate.routes'));
...
router.use('/service-visits', require('./servicevisit.routes'));
...
router.use('/assurance', require('./assurance.routes'));
